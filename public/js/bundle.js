...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmlkZW90ZWNoZHVkZSIsImEiOiJjbDNjYWhtd2gwMXo3M2Rva3NxZDYyMHB3In0.mUr860LLA0EdChiu-LP8AA';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/videotechdude/cl3d4mvtx000v14my1auh6wlv',
    // style URL
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extends map bounds
...
var stripe = Stripe('pk_test_51L3o2kJ1oqPzAZ2Qy14727bEolnuFi3TcVHHkKXR5njXH68smsbKjl3biIQwERmN23XViwzStaxCnWDjmcYu9fFI00DhHGY1gq');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2 Create check form + Charge the credit card
